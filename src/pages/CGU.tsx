        ...
        <div className="space-y-6 text-foreground leading-relaxed">
          <section>
            ...
            <p className="text-muted-foreground mt-2">
              SOMA GATE est une plateforme technologique permettant :
            </p>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              SOMA GATE agit exclusivement en tant que plateforme de mise en relation.
            </p>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              L'accès à SOMA GATE est gratuit. Certaines fonctionnalités nécessitent la création d'un compte utilisateur. L'utilisateur reconnaît disposer des moyens techniques nécessaires pour accéder à la plateforme. SOMA GATE se réserve le droit de suspendre temporairement l'accès pour maintenance ou raisons de sécurité.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Les annonces sont publiées sous la seule responsabilité de leurs auteurs.
            </p>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              SOMA GATE peut procéder à une modération des contenus afin de vérifier leur conformité avec les règles de la plateforme. Cette modération vise à limiter les abus, contenus inappropriés ou manifestement trompeurs. Elle ne constitue en aucun cas une validation juridique, financière ou commerciale.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              SOMA GATE met à disposition des outils de communication entre utilisateurs. SOMA GATE n'intervient pas dans les échanges et ne peut être tenue responsable :
            </p>
            <ul className="list-disc pl-6 text-muted-foreground mt-2 space-y-1">
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              SOMA GATE ne gère aucun paiement, acompte ou flux financier. Toute transaction financière est réalisée en dehors de la plateforme, sous la responsabilité exclusive des parties concernées.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Les données personnelles sont traitées conformément à la Loi PDP indonésienne et à la Politique de confidentialité de SOMA GATE. L'utilisateur dispose de droits d'accès, de rectification et de suppression de ses données.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              L'ensemble des éléments composant SOMA GATE (marque, logo, interface, contenus, fonctionnalités) est protégé par les lois relatives à la propriété intellectuelle. Toute reproduction non autorisée est interdite.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              SOMA GATE se réserve le droit de suspendre ou supprimer un compte en cas de violation des présentes CGU. L'utilisateur peut demander la suppression de son compte à tout moment.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              SOMA GATE se réserve le droit de modifier les présentes CGU à tout moment. La version en vigueur est celle accessible sur la plateforme.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Les présentes CGU sont régies par le droit indonésien. En cas de litige, une solution amiable sera recherchée avant toute action judiciaire.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Toute question relative aux présentes CGU peut être adressée via les coordonnées indiquées dans l'application ou à l'adresse : contact@somagate.com
            </p>
          </section>
        </div>

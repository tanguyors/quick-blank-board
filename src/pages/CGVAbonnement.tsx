  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-5 py-8">
        ...
        <h1 className="text-3xl font-bold text-foreground mb-2">Conditions Générales de Vente — Abonnements</h1>
        ...
        <div className="space-y-6 text-foreground leading-relaxed">
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Les tarifs des abonnements sont indiqués clairement au moment de la souscription, dans la devise applicable. Les prix peuvent être mensuels, trimestriels ou annuels.
            </p>
            <p className="text-muted-foreground mt-2">
              SOMA GATE se réserve le droit de modifier ses tarifs à tout moment. Toute modification n'affecte pas les abonnements déjà en cours.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">Les abonnements sont souscrits pour la durée choisie par l'utilisateur. Sauf mention contraire :</p>
            <ul className="list-disc pl-6 text-muted-foreground mt-2 space-y-1">
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Conformément aux règles applicables aux services numériques, en souscrivant à un abonnement et en accédant immédiatement aux fonctionnalités, l'utilisateur :
            </p>
            <ul className="list-disc pl-6 text-muted-foreground mt-2 space-y-1">
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              SOMA GATE peut faire évoluer le contenu des abonnements, ajouter ou retirer des fonctionnalités, pour des raisons techniques ou commerciales. Ces évolutions ne donnent lieu à aucun remboursement.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Les données personnelles collectées dans le cadre des abonnements sont traitées conformément à la Loi indonésienne n°27 de 2022 sur la protection des données personnelles (PDP Law). Les modalités sont détaillées dans la Politique de confidentialité.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              La souscription à un abonnement n'emporte aucun transfert de droits de propriété intellectuelle. Tous les éléments de SOMA GATE demeurent la propriété exclusive de la plateforme.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Les présentes CGV Abonnement sont régies par le droit indonésien. En cas de litige, une solution amiable sera recherchée avant toute action judiciaire.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Toute question relative aux abonnements peut être adressée via les coordonnées indiquées sur la plateforme ou à l'adresse : contact@somagate.com
            </p>
          </section>
        </div>

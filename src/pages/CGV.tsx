        ...
        <div className="space-y-6 text-foreground leading-relaxed">
          <section>
            ...
            <p className="text-muted-foreground">
              Les présentes Conditions Générales de Vente (ci-après les « CGV ») ont pour objet de définir les conditions dans lesquelles SOMA GATE propose des services payants optionnels sur sa plateforme de mise en relation immobilière. Les CGV complètent les Conditions Générales d'Utilisation (CGU), qui demeurent applicables.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Les prix des services payants sont indiqués en devise locale ou internationale, toutes taxes comprises lorsque applicable. SOMA GATE se réserve le droit de modifier ses tarifs à tout moment. Les services déjà souscrits restent facturés au tarif en vigueur au moment de l'achat.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground mt-2">
              SOMA GATE ne conserve aucune donnée bancaire. Le paiement est exigible immédiatement lors de la souscription.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Conformément aux règles applicables aux contenus et services numériques, le droit de rétractation peut ne pas s'appliquer dès lors que l'exécution du service a commencé. En souscrivant, l'utilisateur reconnaît expressément renoncer à son droit de rétractation lorsque le service est activé immédiatement.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Sauf disposition légale impérative ou erreur technique avérée, aucun remboursement n'est accordé. Les services utilisés ou en cours ne peuvent être annulés rétroactivement. Les demandes de remboursement liées aux paiements via stores sont soumises aux politiques d'Apple ou Google.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              SOMA GATE se réserve le droit de suspendre ou résilier l'accès à un service payant en cas de non-respect des CGU ou CGV, d'usage frauduleux, ou de comportement contraire à la loi. Aucun remboursement ne sera dû en cas de suspension pour faute.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              SOMA GATE peut faire évoluer, modifier ou interrompre un service payant pour des raisons techniques ou commerciales. Lorsque possible, l'utilisateur sera informé à l'avance.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Les données personnelles collectées dans le cadre des services payants sont traitées conformément à la Loi indonésienne n°27 de 2022 sur la protection des données personnelles (PDP Law). Les modalités sont précisées dans la Politique de confidentialité.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Les services payants n'emportent aucun transfert de droits de propriété intellectuelle. Toute reproduction ou exploitation non autorisée des éléments de SOMA GATE est interdite.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Les CGV s'appliquent pendant toute la durée d'utilisation des services payants. L'utilisateur peut mettre fin à son abonnement selon les modalités prévues par le store utilisé.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Les présentes CGV sont régies par le droit indonésien. En cas de litige, une solution amiable sera recherchée avant toute action judiciaire.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Toute question relative aux services payants peut être adressée via les coordonnées indiquées sur la plateforme ou à l'adresse : contact@somagate.com
            </p>
          </section>
        </div>
